...
<!-- Mirrored from themesbrand.com/minia/layouts/auth-confirm-mail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Jun 2023 05:22:02 GMT -->
<head>

        <meta charset="utf-8" />
        <title> Confirm Mail Admin Dashboard</title>
    ...
    <div class="mt-4 mt-md-5 text-center">
        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Design & develop by Agicent</p>
                                    </div>
                                </div>
                            </div>
                        </div>
