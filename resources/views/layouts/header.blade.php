...
<head>
    ...
    <meta charset="utf-8" />
    <title>iCourt Admin Dashboard </title>
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="/dashboard" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="assets/images/iCourtLogo.jpg" alt="" height="40">
                            </span>
                            <span class="logo-lg">
                                <img src="assets/images/iCourtLogo.jpg" alt="" height="40">
                        ...
                        <a href="{{url('/dashboard')}}" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="assets/images/iCourtLogo.jpg" alt="" height="30">
                            </span>
                            <span class="logo-lg">
                                <img src="assets/images/iCourtLogo.jpg" alt="" height="30"> <span
                                    class="logo-txt">iCourt</span>
                            </span>
                        </a>
                    </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item bg-light-subtle border-start border-end"
                            ...
                            <span
                                class="d-none d-xl-inline-block ms-1 fw-medium">{{session()->get('admin')->admin_name}}</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="{{url('/logout')}}">
                                <i class="mdi mdi-logout font-size-16 align-middle">
                                </i> Logout</a>
                        </div>
                    </div>
