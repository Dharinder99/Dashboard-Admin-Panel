@extends('layouts.master')
 ...
 <!-- ============================================================== -->
    ...
    {!! Form::open(['url' => '/user-search', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
    <?php for ($i = 0; $i <= 3; $i++) { ?>
    ...
    {!! Form::label('search_in', 'Search In') !!}
     <select name="search_in[{{$i}}]" id = "search_in_{{$i}}" data-id="{{$i}}" class="search_in js-states form-control select2-selection__rendered" tabindex="-1" style="width: 100%">
                                            ...
                                            <option value="email_address" @if(isset($inputValue) && ($inputValue['search_in'][$i]=='email_address' )){{{ "selected" }}} @endif>Email Address</option>
                                            <option value="phone_no" @if(isset($inputValue) && ($inputValue['search_in'][$i]=='phone_no' )){{{ "selected" }}} @endif>Phone No.</option>
                                            {{-- <option value="gender_flag" @if(isset($inputValue) && ($inputValue['search_in'][$i]=='gender_flag' )){{{ "selected" }}} @endif>Gender</option> --}}
                                           ...
                                           {{-- <option value="is_verified" @if(isset($inputValue) && ($inputValue['search_in'][$i] == 'is_verified')){{{ "selected" }}} @endif >Is Active </option> --}}
                                            <option value="create_datetime" @if(isset($inputValue) && ($inputValue['search_in'][$i]=='create_datetime' )){{{ "selected" }}} @endif>Registered On</option>
            ...
            <div class="card-header">
                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                    ...
                    <td><img src="assets/images/users/avatar-2.jpg" alt="" class="avatar-sm rounded-circle me-2">
                        <a href="#"  data-bs-toggle="modal" data-bs-target=".bs-example-modal-center">{{$item->full_name}}</a></td>
                    ...
                    <td> --}}
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a id = "view-user" class="btn btn-outline-secondary btn-sm edit view-user" title="View Profile" data-id="{{ $item->user_id }}" data-bs-toggle="modal" href="#view-user-modal">
                                    View Profile</a>
