                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! Form::open(['url' => '/inquiry', 'method' => 'post', 'enctype' =>
                            'multipart/form-data']) !!}
                            <?php for ($i = 0; $i <= 3; $i++) { ?>
...
{ echo $inputValue['datefilter'][$i]; } ?>" readonly required>
                                        </span>
                                    </div>
                            ...
                            <table id="datatable-buttons"
                                ...
                                <thead>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <th class="text-center">Inquiry message</th>
...
<a href="#" class=" btn-sm edit view-user" title="View Profile" data-id="{{ $item->user_id }}" data-bs-toggle="modal" data-bs-target="#viewUserDetails">{{$item->full_name}}</a> </td>

                                        <td>{{$item->inquiry_date}}</td>
                                        <td>{{$item->inquiry_message}}</td>
    ...
    title="Delete" data-id="{{ $item->id }}" data-bs-toggle="modal"
        href="#delete-user-modal" class="dropdown-item delete-user">
        <i class="fas fa-trash-alt red-icon" style="color: red">
            </i>&nbsp;
            &nbsp;Delete</a>
                                        </td>
        ...
        <div class="modal-dialog modal-dialog-centered " role="document">
            <div class="modal-content tx-14">
                <div class="modal-header modal-top-header">
                    <h5 class="modal-title modal-top-title" id="exampleModalLabel4"><b>Delete Inquiry</b></h5>
                    {{-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    --}}
                </div>
                ...
                <div class="modal-body">
                    <p class="mg-b-0"><b>Are you sure you want to delete this Inquiry?</b></p>
    ...
    <script>
        ...
        // $.ajax({
        //     url: '/getUserData', // URL to your server-side PHP script
        //     method: 'POST',
