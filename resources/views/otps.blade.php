...
<html lang="en">
    ...
    <form class="mt-4" action="{{url('/sendotp')}}"  method="Post" >
        @csrf
    <div class="mb-3">
             <label class="form-label">O T P </label>
    <input type="text" class="form-control" id="email" placeholder="Enter The OTP" required>
    </div>

<div class="mb-3 mt-4">
    {{-- <a href = "{{'/verfication'}}"> --}}

        <button class="btn btn-secondary w-100 waves-effect waves-light" type="submit">Confirm
         </button></a>
    ...
    <p class="text-muted mb-0">Remember It ?
        <a href="{{'/login'}}" class="text-primary fw-semibold"> Log In </a> </p>
                                        </div>
